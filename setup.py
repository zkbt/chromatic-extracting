...
if "release" in sys.argv[-1]:
    ...
    os.system("rm -rf dist/chromatic_extracting*")
    sys.exit()

# a little kludge to get the version number from __version__
exec(open("chromatic_extracting/version.py").read())

# run the setup function
setup(
    # the name folks can use to search for this with pip
    name="chromatic_extracting",
    # what version of the code is this?
    version=__version__,
    # what's a short description of the package?
    description="Tools for extracting spectra from time-series astronomical images.",
    # what's a more detailed description?
    long_description="Read the complete documentation at https://zkbt.github.io/chromatic_extracting/",
    ...
    url="https://github.com/zkbt/chromatic_extracting/",
